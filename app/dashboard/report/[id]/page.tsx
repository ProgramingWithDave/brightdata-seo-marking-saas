...
import { formatDateTime, getProgressBarStyle, getProgressPercentage, getReportTitle, getSpinnerColor, getStatusMessage } from "@/lib/status-utils";
...
function ReportPPage() {
  ...
  if (job === null) {
    ...
    <div className="flex items-center justify-center min-h-screen">
      ...
      <span className="text-muted-foreground">Reports not Found</span>
    </div>
    )
  }
  return (
